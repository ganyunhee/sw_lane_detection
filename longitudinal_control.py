...
class LongitudinalController:
    ...
    functions:
        ...
        control()
    '''
    def __init__(self, KP=0.0, KI=0.0, KD=0.098):
        self.last_error = 0
        self.sum_error = 0
        self.last_control = 0
        self.speed_history = []
    ...
    def PID_step(self, speed, target_speed):
        ...
        # --> e(t) = target speed - speed
        error = target_speed - speed
        
        # derive PID elements
        # --> control = KP*e(t) + KD*(e(t) - e(t - 1)) + KI(sum of all e(t))
        control = (self.KP * error) + (self.KD * ((error - self.last_error))) + (self.KI * self.sum_error)
        self.last_control = control
        self.sum_error += error
        self.sum_error = np.clip(self.sum_error, -(1/2), 1/2)
        self.last_error = error
        
        # CMNT: Tune parameters
        # KP = 0.01, KI = 0, KD = 0
        # vmax = 60, vmin = 30, KV = 4.5
        # -- note : modify a single term at a time 
